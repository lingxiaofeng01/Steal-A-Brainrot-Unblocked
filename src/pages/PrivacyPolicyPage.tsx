          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
            <div className="prose max-w-none">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800 text-sm">
                      At Steal a Brainrot, we are committed to protecting your privacy. This policy explains 
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                <li><strong>Comments and Reviews:</strong> Name, email, and comment content</li>
                <li><strong>Contact Forms:</strong> Name, email, subject, and message</li>
                <li><strong>Ratings:</strong> Game ratings and preferences</li>
              </ul>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                ...
                <li><strong>Browser Fingerprint:</strong> To prevent duplicate ratings (non-personally identifiable)</li>
              </ul>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                ...
                <li>Displaying user comments and ratings</li>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                ...
                <li>Prevent duplicate ratings and votes</li>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">4. Third-Party Services</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Our website uses third-party services that may collect information:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                <li><strong>Supabase:</strong> Database and authentication services</li>
                <li><strong>Game Platforms:</strong> Embedded games from third-party providers</li>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6 ml-4">
                <li><strong>With Service Providers:</strong> To help operate our website</li>
                <li><strong>For Legal Reasons:</strong> To comply with laws or legal processes</li>
                <li><strong>To Protect Rights:</strong> To protect our rights, property, or safety</li>
                <li><strong>With Consent:</strong> When you explicitly agree</li>
              </ul>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">8. Your Rights</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <a href="mailto:privacy@stealbrainrot.com" className="text-cyan-600 hover:text-cyan-700 font-medium">
                  privacy@stealbrainrot.com
                </a>
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">9. Data Retention</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
                We retain your information only as long as necessary to provide our services and comply with 
                legal obligations. Comments and ratings are retained indefinitely unless you request deletion.
              </p>

              <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">10. International Data Transfers</h2>
              <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <div className="bg-cyan-50 rounded-lg p-4 border-2 border-cyan-200">
                <p className="text-gray-900 mb-2">
                  <strong>Email:</strong>{' '}
                  <a href="mailto:privacy@stealbrainrot.com" className="text-cyan-600 hover:text-cyan-700">
                    privacy@stealbrainrot.com
                  </a>
                </p>
                <p className="text-gray-900">
                  <strong>Website:</strong>{' '}
                  <a href="/contact" className="text-cyan-600 hover:text-cyan-700">
                    Contact Form
                  </a>
                </p>
              </div>

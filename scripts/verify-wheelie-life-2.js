...
const gameSlug = 'wheelie-life-2';
const gameName = 'Wheelie Life 2';
const releaseDate = '2025-11-05';
const tags = ['Sports', 'Racing', 'Bike', 'Stunt', 'Skill', 'Driving', 'Simulation', 'Arcade'];

console.log('🔍 开始验证 Wheelie Life 2 游戏配置...\n');
...
// 4. 检查游戏页面组件
console.log('\n4️⃣ 检查游戏页面组件...');
const pagePath = path.join(__dirname, '..', 'src', 'pages', 'WheelieLife2Page.tsx');
...
if (gameDetailPageContent.includes(`'${gameSlug}'`)) {
  ...
  if (gameDetailPageContent.includes('WheelieLife2Page')) {
...
const migrationPath = path.join(__dirname, '..', 'supabase', 'migrations', `20251105_add_wheelie_life_2.sql`);
